...
const Sidebar = () => {
    ...
    return (
        <aside className={`w-60 bg-slate-900 flex flex-col flex-shrink-0 translate-all duration-300`}>
            ...
            <div className="px-2 py-4 border-t border-slate-800 space-y-1">
                <div className="flex items-center gap-3 px-3 py-2 mb-1">
                    ...
                    <div className="min-w-0">
                        <p className="text-white text-xs font-medium truncate">Dara Keo</p>
